...
function App() {
  ...
  let todoListTemplate = [
    '턱걸이 5회 x 3세트', '스쿼트 20회 x 3세트', '푸쉬업 15회 x 3세트',
    '마운틴클라이머 20회 x 3세트', '점핑잭 20회 x 3세트', '백익스텐션 15회 x 3세트',
    '덤벨프레스 10회 x 3세트', '덤벨컬 15회 x 각 2세트', '스컬크러셔 10회 x 3세트',
    '사이드 레터럴 레이즈 15회 x 3세트', '단백질 파우더 마시기', '공부 30분', '샤워'
  ];
